...
describe("v2 known_hash_set 数据集注册表", () => {
  it("版本不可变、引用可发现，并在控制端完成 MATCH 裁定且不向目标下发哈希集合", async () => {
    ...
    const epoch: ScanEpoch = { epochId: "EPOCH-00000000-0000-4000-8000-000000000211", taskId: task.taskId, targetFingerprint: task.target.hostFingerprint, protocolVersion: 2, manifestVersion: "3.0.0", helperVersion: "3.0.0", reason: "INITIAL", status: "RUNNING", startedAt: new Date().toISOString() };

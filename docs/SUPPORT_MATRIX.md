...
> 更新日期：2026-08-26。`已验证`仅表示仓库自动化或明确环境已通过；`待实机验收`不等同于不支持，而是不应在报告中宣称已验证。2026-08-26 已在 Ubuntu 24.04 ARM64 完成 v2 smoke 4/4、五类 QUICK、联合 STANDARD、小上下文 DEEP 与冻结模型能力评测，结果为 `PASS_WITH_LIMITATIONS`。
>

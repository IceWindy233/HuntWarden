...
const definitions: Record<NamespaceName, { identity: readonly string[]; fields: Record<string, ManifestField>; relations?: readonly string[] }> = {
  host: { identity: ["bootId"], fields: { bootId: publicField("string"), hostname: publicField("string"), os: publicField("string"), distribution: publicField("string"), distributionVersion: publicField("string"), release: publicField("string"), architecture: publicField("string"), timezone: publicField("string"), initSystem: publicField("string"), selinuxMode: publicField("string"), observedAt: publicField("timestamp") } },
  process: { identity: ["bootId", "pid", "startTicks"], fields: { bootId: publicField("string"), pid: publicField("integer"), startTicks: publicField("string"), ppid: publicField("integer"), uid: publicField("integer"), username: publicField("string"), comm: publicField("string"), exe: sensitiveField("string"), exeDeleted: publicField("boolean"), exeSize: publicField("integer"), exeInode: publicField("string"), exeSha256: publicField("string", { cost: "EXPENSIVE", enumerable: true }), command: sensitiveField("string"), launcherPath: sensitiveField("string"), cwd: sensitiveField("string"), root: sensitiveField("string"), environment: sensitiveField("object", "PRESENCE_ONLY", { sortable: false }), namespaces: publicField("object", { sortable: false }), cgroups: sensitiveField("string[]", "HASH_ONLY", { sortable: false }), cgroupsTruncated: publicField("boolean"), mapsSummary: sensitiveField("object", "VALUE", { sortable: false }), state: publicField("string"), startedAt: publicField("timestamp") }, relations: ["parent", "children", "opens", "connects", "executable", "command_file", "started_by"] },
  socket: { identity: ["protocol", "localAddress", "localPort", "remoteAddress", "remotePort", "inode"], fields: { protocol: publicField("string"), localAddress: publicField("string"), localPort: publicField("integer"), remoteAddress: publicField("string"), remotePort: publicField("integer"), state: publicField("string"), inode: publicField("string"), pid: publicField("integer"), ownerBootId: publicField("string"), ownerStartTicks: publicField("string"), ownerPidNamespace: publicField("string"), intelProvider: publicField("string", { enumerable: false }), intelMalicious: publicField("boolean", { enumerable: false }), intelRiskLevel: publicField("string", { enumerable: false }), intelConfidence: publicField("number", { enumerable: false }), intelThreatTypes: publicField("string[]", { enumerable: false, sortable: false }), intelQueriedAt: publicField("timestamp", { enumerable: false }) }, relations: ["owned_by"] },
  ...
  ssh_trust_config: { identity: ["scope", "directive", "valueDigest"], fields: { scope: publicField("string"), directive: publicField("string"), valueDigest: publicField("string"), value: sensitiveField("string"), source: sensitiveField("string"), effective: publicField("boolean") }, relations: ["references"] },
  ...
  unit: { identity: ["scope", "ownerUid", "name", "fragmentDigest"], fields: { scope: publicField("string"), ownerUid: publicField("integer"), name: publicField("string"), fragmentDigest: publicField("string"), path: sensitiveField("string"), enabled: publicField("boolean"), active: publicField("boolean"), generated: publicField("boolean"), transient: publicField("boolean"), execStart: sensitiveField("string"), user: publicField("string") }, relations: ["executes"] },
  ...
  java_component: { identity: ["jvmDigest", "context", "componentKind", "name", "classLoaderId"], fields: { jvmDigest: publicField("string"), context: publicField("string"), componentKind: publicField("string"), name: publicField("string"), className: publicField("string"), classLoaderId: publicField("string"), mappings: sensitiveField("string[]") }, relations: ["implemented_by"] },
...
export const PROTOCOL_MANIFEST: Readonly<{ version: string; namespaces: Readonly<Record<NamespaceName, NamespaceManifest>>; relations: readonly string[]; hardLimits: Readonly<Record<string, number>> }> = Object.freeze({
  ...
  hardLimits: Object.freeze({ predicateDepth: 4, predicateNodes: 32, queryPredicateDepth: 6, queryPredicateNodes: 64, predicateStringBytes: 256, predicateInItems: 64, enumerateLimit: 500, enumerateScanNodes: 5_000, projectFields: 32, readBytes: 65_536, collectBytes: 104_857_600, matchRefs: 128, matchHits: 500, factBatchRows: 2_048 }),
});

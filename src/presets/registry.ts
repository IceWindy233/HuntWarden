...
export const PRESET_REGISTRY: readonly PresetDefinition[] = [
  {
    ...
    steps: [
      ...
      { stepId: "web-root", verb: "enumerate", params: { namespace: "web_root", fields: ["mountId", "device", "inode", "path", "server", "effective"], limit: 200 }, required: true },
  ...
  },
  {
    ...
    steps: [
      ...
      { stepId: "delegation-rules", verb: "enumerate", params: { namespace: "delegation_rule", fields: ["mechanism", "sourceDigest", "line", "ruleDigest", "source", "effect", "subject", "runAs", "statement"], limit: 500 }, required: true },
      { stepId: "effective-ssh-trust", verb: "enumerate", params: { namespace: "ssh_trust_config", fields: ["scope", "directive", "valueDigest", "value", "source", "effective"], limit: 200 }, required: true },
    ...
    coverageCriteria: [{ criterion: "account-db", stepIds: ["account-db"] }, { criterion: "privileged-groups", stepIds: ["account-db"] }, { criterion: "delegation-config", stepIds: ["delegation-rules"] }, { criterion: "ssh-trust", stepIds: ["authorized-keys", "effective-ssh-trust"] }, { criterion: "login-history", stepIds: ["account-auth-events"] }],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { stepId: "triage-file-scopes", verb: "enumerate", params: { namespace: "file", fields: ["mountId", "device", "inode", "path", "kind", "size", "mode", "uid", "gid", "mtime", "contentClass"], limit: 200 }, required: true },
      { stepId: "package-owned-files", verb: "relate", params: { relation: "owns_file", packageNames: ["coreutils", "bash", "openssh-server", "systemd"], packageLimit: 1, limit: 20 }, required: true },
      { stepId: "package-file-verify", verb: "verify", params: { baseline: "package_db", limit: 5 }, required: true },
    ],
    coverageCriteria: [{ criterion: "volatile-state", stepIds: ["process-snapshot", "socket-snapshot"] }, { criterion: "file-scopes", stepIds: ["triage-file-scopes"] }, { criterion: "event-sources", stepIds: ["auth-events", "exec-events"] }, { criterion: "kernel-modules", stepIds: ["kernel-modules"] }, { criterion: "package-inventory", stepIds: ["package-baseline"] }, { criterion: "package-verify", stepIds: ["package-owned-files", "package-file-verify"] }],
  },
] as const;

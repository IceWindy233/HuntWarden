...
const api: HuntWardenDesktopApi = {
  ...
  listKnownHashDataSets: async () => await ipcRenderer.invoke(IPC.dataSetList),
  importKnownHashDataSet: async () => await ipcRenderer.invoke(IPC.dataSetImport),
  ...
  pauseTask: async (taskId) => await ipcRenderer.invoke(IPC.taskPause, taskId),
  resumeTask: async (taskId) => await ipcRenderer.invoke(IPC.taskResume, taskId),
  ...
  decideGrantRequest: async (input) => await ipcRenderer.invoke(IPC.grantRequestDecide, input),
  recordHumanAssessment: async (input) => await ipcRenderer.invoke(IPC.humanAssessmentRecord, input),
  revokeTaskGrant: async (input) => await ipcRenderer.invoke(IPC.taskGrantRevoke, input),

export const IPC = {
  ...
  dataSetList: "huntwarden:dataset:list",
  dataSetImport: "huntwarden:dataset:import",
  ...
  grantRequestDecide: "huntwarden:grant-request:decide",
  humanAssessmentRecord: "huntwarden:assessment:human:record",
  taskGrantRevoke: "huntwarden:task-grant:revoke",
